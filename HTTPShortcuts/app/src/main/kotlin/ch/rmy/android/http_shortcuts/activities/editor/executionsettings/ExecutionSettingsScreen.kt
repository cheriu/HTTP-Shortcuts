...
fun ExecutionSettingsScreen() {
    ...
    SimpleScaffold(
        ...
        ExecutionSettingsContent(
            ...
            autoUpdateOnIpChange = viewState.autoUpdateOnIpChange,
            autoUpdateOnIpChangeOptionVisible = viewState.autoUpdateOnIpChangeOptionVisible,
            debounceWindowMs = viewState.debounceWindowMs,
            ...
            onAutoUpdateOnIpChangeChanged = viewModel::onAutoUpdateOnIpChangeChanged,
            onDebounceWindowChanged = viewModel::onDebounceWindowChanged,
