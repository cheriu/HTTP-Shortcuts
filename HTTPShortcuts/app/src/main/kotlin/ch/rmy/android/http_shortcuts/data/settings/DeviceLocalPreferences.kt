...
constructor(
    ...
    var lastNetworkChangeState: String?
        get() = getString(KEY_LAST_NETWORK_CHANGE_STATE)
        set(value) = putString(KEY_LAST_NETWORK_CHANGE_STATE, value)
    ...
    companion object {
        ...
        private const val KEY_LAST_NETWORK_CHANGE_STATE = "last_network_change_state"
